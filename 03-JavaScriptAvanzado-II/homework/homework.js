...
function cacheFunction(cb) { 
  ...
  return function(arg){
    ...
    return cache[arg]}
if (cache[arg] = cb(arg)){               
return cache[arg]}   // cb va a ser cualquier funcion que pasemos como argumento a futuro
  }    
}
  ...
  recibe por parámetro (cb); es decir, que "recuerde" el resultado de cada operación que hace, de manera que, al realizar
   una operación por segunda vez, se pueda obtener el resultado de esa "memoria" sin tener que efectuar otra vez cálculos 
  ...
  squareCache(5)    // no volverá a invocar a square, simplemente buscará en la caché cuál
                       es el resultado de square(5) y lo retornará (tip: si usaste un objeto, 
