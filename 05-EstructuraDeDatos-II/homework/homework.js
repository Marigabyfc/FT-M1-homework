...
Implementar la clase LinkedList, definiendo los siguientes métodos:
  ...
  el parámetro puede ser un valor o un callback. En el primer caso, buscamos un nodo cuyo valor coincida con 
  lo buscado; en el segundo, buscamos un nodo cuyo valor, al ser pasado como parámetro del callback, retorne true. 
  Ejemplo: 
...
LinkedList.prototype.add = function(value){
  ...
  LinkedList.prototype.search = function(value){
     if ( value == newnodo[value]){
      return newnodo.hasOwnProperty(value)
     }
  }
...
La clase debe tener los siguientes métodos:
  ...
  input alfabético, suma el código numérico de cada caracter del input (investigar el método 
    charCodeAt de los strings) y calcula el módulo de ese número total por la cantidad de buckets; 
...
chequear, con hasKey, si ya hay algo en la tabla con el nombre 'instructora'; luego, invocando 
...
var newelement = new Elemento()

HashTable.prototype.hash = function(key, i){
   return key.charCodeAt(i) % 35
}

HashTable.prototype.set = function(key, value){
  var pos = 0
  pos = pos + this.key.hash()
  newhash[pos] = newelement[key] 
  return newhash
}
